...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col bg-[url('https://svgur.com/i/18Eh.svg')] sm:bg-[url('/bg.svg')] bg-cover bg-no-repeat md:h-[100vh] md:justify-center justify-end
        sm:px-[0px]
        md:px-[10px]
        2xl:px-[300px]
        bg-mobile
