...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col  md:justify-center justify-end
        bg-mobile
        ">
        <div className="flex flex-row w-full p-[16px] md:px-[100px] md:py-[15px] justify-center items-center">
          <Image
            src="/logo.svg"
            alt="Babol Logo"
        ...
        <div className="flex flex-col mt-6 md:mt-0 md:h-full gap-20 md:gap-10 ">
          <div className="flex flex-col md:flex-row md:px-[100px]">
